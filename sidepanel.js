...
const TABS = {
  ...
  tetris: {
    url: chrome.runtime.getURL('tetris.html'),
    title: 'Tetris',
    frame: document.getElementById('tt-frame'),
...
const LOGO_ICONS = {
  ...
  tetris: '<svg viewBox="0 0 24 24"><path d="M2 6h6v6H2zm7 0h6v6H9zm7 0h6v6h-6zm-7 7h6v6H9z"/></svg>'
};
...
const LOGO_COLORS = {
  ...
  tetris: { bg: 'rgba(189,147,249,.12)', border: 'rgba(189,147,249,.25)' }
};
...
function switchTab(name) {
  ...
  const accentMap = { whatsapp: 'var(--green)', instagram: 'var(--ig)', claude: 'var(--claude)', tetris: 'var(--tetris)' };
...
TABS.tetris.frame.addEventListener('load', () => onFrameLoad('tetris'));
